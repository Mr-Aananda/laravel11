                    ...
                    <header class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                {{ __("Fill in the details below to create a new blog post.") }}
                            </p>
                        </div>
                ...
                <section>
                    <form method="POST" action="{{ route('blog.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea id="details" class="block mt-1 w-full" name="details" rows="5" required>{{ old('details') }}</x-textarea>
